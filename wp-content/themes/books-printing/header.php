				...
				<div class="col-lg-7 col-md-12 text-lg-start  text-center align-self-center ">
					...
					<?php if ( get_theme_mod('books_printing_header_button_url') || get_theme_mod('books_printing_header_button_text') ) : ?>
						<div class="shop-btn  py-2">
							<a class="border-left ps-1" href="<?php echo esc_url( get_theme_mod('books_printing_header_button_url' ) ); ?>"><?php echo esc_html( get_theme_mod('books_printing_header_button_text' ) ); ?></a>
						</div>
					<?php endif; ?>
				</div>
					...
					<div class="row">
						<?php if ( get_theme_mod('books_printing_header_phone_number') ) : ?>
							<div class="col-lg-5 col-md-6 col-12 align-self-center py-2">
								<a href="tel:<?php echo esc_url( get_theme_mod('books_printing_header_phone_number' ) ); ?>"><p class="mb-0 phone-no"><?php esc_html_e('Call Us: ','books-printing'); ?><?php echo esc_html( get_theme_mod('books_printing_header_phone_number' ) ); ?></p></a>
							</div>
						<?php endif; ?>
						<?php if ( get_theme_mod('books_printing_header_email') ) : ?>
							<div class="col-lg-7 col-md-6 col-12 align-self-center border-side my-2">
								<a href="mailto:<?php echo esc_url( get_theme_mod('books_printing_header_email' ) ); ?>"><p class="mb-0 email "><?php esc_html_e('Mail Us: ','books-printing'); ?><?php echo esc_html( get_theme_mod('books_printing_header_email' ) ); ?></p></a>
							</div>
						<?php endif; ?>
					</div>
				</div>
					...
					<?php if ( get_theme_mod('books_printing_cart_box_enable', 'on' ) == true ) : ?>
						<?php if ( class_exists( 'woocommerce' ) ) {?>
							<span class="header-cart">
								<a class="cart-customlocation" href="<?php if(function_exists('wc_get_cart_url')){ echo esc_url(wc_get_cart_url()); } ?>" title="<?php esc_attr_e( 'View Shopping Cart','books-printing' ); ?>"><i class="fas fa-shopping-cart me-1"></i></a>
							</span>
						<?php }?>
					<?php endif; ?>
				</div>
