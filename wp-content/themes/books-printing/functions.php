 ...
 */
 ...
 function books_printing_logo_resizer() {
	...
	$books_printing_theme_custom_logo_id = get_theme_mod( 'custom_logo' );
	$books_printing_theme_logo_width = get_theme_mod( 'books_printing_logo_resizer', 150 ); // Default to 200 if not set
	$books_printing_theme_logo_height = $books_printing_theme_logo_width * 0.5;

	if ( $books_printing_theme_custom_logo_id ) {
		$books_printing_theme_logo_data = wp_get_attachment_image_src( $books_printing_theme_custom_logo_id, 'full' );
		$books_printing_theme_logo_url = $books_printing_theme_logo_data[0];
		$books_printing_theme_original_width = $books_printing_theme_logo_data[1];
		$books_printing_theme_original_height = $books_printing_theme_logo_data[2];
		$books_printing_theme_aspect_ratio = $books_printing_theme_original_height / $books_printing_theme_original_width;
		$books_printing_theme_logo_height = $books_printing_theme_logo_width * $books_printing_theme_aspect_ratio;
   
	}
	$books_printing_theme_logo_size_css = '
		.custom-logo{
			height: '.esc_attr($books_printing_theme_logo_height).'px !important;
			width: '.esc_attr($books_printing_theme_logo_width).'px !important;
		}
	';
...
define('BOOKS_PRINTING_FREE_THEME_DOC',__('https://preview.wpelemento.com/theme-documentation/books-printing/','books-printing'));
...
define('BOOKS_PRINTING_BUY_NOW',__('https://www.wpelemento.com/products/printing-wordpress-theme','books-printing'));
define('BOOKS_PRINTING_LIVE_DEMO',__('https://preview.wpelemento.com/books-printing/','books-printing'));
define('BOOKS_PRINTING_THEME_BUNDLE',__('https://www.wpelemento.com/products/wordpress-theme-bundle','books-printing'));
