		...
		$manager->add_section(
			new Books_Printing_Customize_Section_Pro(
				...
				array(
					...
					'pro_text'    => esc_html__( 'GET PRO', 'books-printing' ),
					'pro_url'     => 'https://www.wpelemento.com/products/printing-wordpress-theme',
					'priority'    => 5,
				)
			)
		);
		...
		$manager->add_section(
			new Books_Printing_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'     => 'https://preview.wpelemento.com/theme-documentation/books-printing/',
					'priority'    => 5,
				)
			)
		);
		...
		$manager->add_section(
			new Books_Printing_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'     => 'https://preview.wpelemento.com/books-printing/',
					'priority'    => 5,
				)
			)
		);
