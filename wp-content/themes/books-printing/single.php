  ...
  <div class="container">
    <?php if ( get_theme_mod('books_printing_header_page_title' , true)) : ?>
        ...
        <div class="headerimgbox-meta">
          ...
          <?php endwhile; ?>
          <span class="ms-3"><i class="far fa-comments me-2"></i> <?php comments_number( esc_attr('0', 'books-printing'), esc_attr('0', 'books-printing'), esc_attr('%', 'books-printing') ); ?> <?php esc_html_e('comments','books-printing'); ?></span>
        </div>
    <?php endif; ?>
