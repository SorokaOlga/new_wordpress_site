...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">
		  	...
		  	<button class="tablinks" onclick="ebook_store_open_tab(event, 'get_bundle')"><?php esc_html_e( 'Get 250+ Themes Bundle at $99', 'ebook-store' ); ?></button>
		</div>
			...
			<div class="gutenberg-editor-tab" style="<?php echo esc_attr($ebook_store_plugin_custom_css); ?>">
				<div class="block-pattern-img">
					...
					<p><?php esc_html_e('Follow the below instructions to setup Home page with Block Patterns.','ebook-store'); ?></p>
	              	<p><b><?php esc_html_e('Click on Below Add new page button >> Click on "+" Icon.','ebook-store'); ?></b></p>
				    ...
				    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/inc/getstart/images/block-pattern1.png" alt="" />
				    	<p><b><?php esc_html_e('Click on Patterns Tab >> Click on Theme Name >> Click on Sections >> Publish.','ebook-store'); ?></b></p>
		...
		<div id="product_addons_editor" class="tabcontent">
			...
			<?php }else{ ?>
				...
				<div class="ebook-store-pattern-page">
					...
					<p><b><?php esc_html_e('2. Go To Dashboard >> Ibtana Settings >> Woocommerce Templates','ebook-store'); ?></b></p>
	            <div class="ebook-store-pattern-page-btn">
	              	...
	              	<p><?php esc_html_e('You can create a template as you like.','ebook-store'); ?></p>
			    </div>
			<?php } ?>
		</div> 
		...
		<div id="theme_pro" class="tabcontent">
		    ...
		    <div class="col-left-pro">
		    	...
		    	<div class="pro-links">
					...
					<a href="<?php echo esc_url( VW_BOOK_STORE_THEME_BUNDLE_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Get 250+ Themes Bundle at $99', 'vw-book-store'); ?></a>
				</div>
		    </div>
					...
					<table class="tablebox">
						...
						<tbody>
							...
							<tr>
								...
								<td class="table-img"><?php esc_html_e('3', 'ebook-store'); ?></td>
								<td class="table-img"><?php esc_html_e('12', 'ebook-store'); ?></td>
							</tr>
							<tr class="odd">
							...
							<tr>
								...
								<td class="table-img"><?php esc_html_e('13', 'ebook-store'); ?></td>
							</tr>
							<tr class="odd">
							...
							<tr class="odd">
								<td><?php esc_html_e('WordPress 6.4 or later', 'ebook-store'); ?></td>
								<td class="table-img"><span class="dashicons dashicons-no"></span></td>
								<td class="table-img"><span class="dashicons dashicons-saved"></span></td>
							</tr>
							<tr>
								<td><?php esc_html_e('PHP 8.2 or 8.3', 'ebook-store'); ?></td>
								<td class="table-img"><span class="dashicons dashicons-no"></span></td>
								<td class="table-img"><span class="dashicons dashicons-saved"></span></td>
							</tr>
							<tr class="odd">
								<td><?php esc_html_e('MySQL 5.6 (or greater) | MariaDB 10.0 (or greater)', 'ebook-store'); ?></td>
								<td class="table-img"><span class="dashicons dashicons-no"></span></td>
								<td class="table-img"><span class="dashicons dashicons-saved"></span></td>
							</tr>
							<tr>
		...
		<div id="get_bundle" class="tabcontent">		  	
		   <div class="col-left-pro">
		   	<h3><?php esc_html_e( 'WP Theme Bundle', 'ebook-store' ); ?></h3>
		    	<p><?php esc_html_e('Enhance your website effortlessly with our WP Theme Bundle. Get access to 250+ premium WordPress themes and 5+ powerful plugins, all designed to meet diverse business needs. Enjoy seamless integration with any plugins, ultimate customization flexibility, and regular updates to keep your site current and secure. Plus, benefit from our dedicated customer support, ensuring a smooth and professional web experience.','ebook-store'); ?></p>
		    	<div class="feature">
		    		<h4><?php esc_html_e( 'Features:', 'ebook-store' ); ?></h4>
		    		<p><?php esc_html_e('250+ Premium Themes & 5+ Plugins.', 'ebook-store'); ?></p>
		    		<p><?php esc_html_e('Seamless Integration.', 'ebook-store'); ?></p>
		    		<p><?php esc_html_e('Customization Flexibility.', 'ebook-store'); ?></p>
		    		<p><?php esc_html_e('Regular Updates.', 'ebook-store'); ?></p>
		    		<p><?php esc_html_e('Dedicated Support.', 'ebook-store'); ?></p>
		    	</div>
		    	<p>Upgrade now and give your website the professional edge it deserves, all at an unbeatable price of $99!</p>
		    	<div class="pro-links">
					<a href="<?php echo esc_url( VW_BOOK_STORE_THEME_BUNDLE_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Buy Now', 'ebook-store'); ?></a>
					<a href="<?php echo esc_url( VW_BOOK_STORE_THEME_BUNDLE_DOC ); ?>" target="_blank"><?php esc_html_e('Documentation', 'ebook-store'); ?></a>
				</div>
		   </div>
		   <div class="col-right-pro">
