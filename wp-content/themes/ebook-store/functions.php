<?php
	...
	function ebook_store_activation_notice() {
		echo '<div class="notice notice-success is-dismissible welcome-notice">';
			...
			echo '<span class="upgrade-btn"><a href="'. esc_url( 'https://www.vwthemes.com/products/ebook-store-wordpress-theme' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'UPGRADE PRO', 'ebook-store' ) .'</a></span>';
		echo '</div>';
	}
	...
	define('EBOOK_STORE_BUY_NOW',__('https://www.vwthemes.com/products/ebook-store-wordpress-theme','ebook-store'));
	...
	define('EBOOK_STORE_CREDIT',__('https://www.vwthemes.com/products/free-ebook-wordpress-theme','ebook-store'));
	...
	if ( ! defined( 'VW_BOOK_STORE_GO_PRO_URL' ) ) {
		define( 'VW_BOOK_STORE_GO_PRO_URL', 'https://www.vwthemes.com/products/ebook-store-wordpress-theme');
	}
...
final class Ebook_Store_Customize {
	...
	public function sections( $manager ) {
		...
		array(
			...
			'pro_url'  => esc_url('https://www.vwthemes.com/products/ebook-store-wordpress-theme'),
		)));
