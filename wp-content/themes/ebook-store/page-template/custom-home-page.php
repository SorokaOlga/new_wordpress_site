...
<main id="maincontent" role="main">
              ...
              <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
                ...
                <div class="carousel-caption">
                  <div class="inner_carousel">
                    ...
                    <?php } ?>
                    <?php
                      $ebook_store_button_text = get_theme_mod('vw_book_store_slider_button_text','READ MORE');
                      $ebook_store_button_link = get_theme_mod('vw_book_store_top_button_url', '');
                      if (empty($ebook_store_button_link)) {
                        $ebook_store_button_link = get_permalink();
                      }
                      if ($ebook_store_button_text || !empty($ebook_store_button_link)) { ?>
                      <div class="more-btn wow zoomInDown" data-wow-duration="3s">
                        <?php if( get_theme_mod('vw_book_store_slider_button_text','READ MORE') != ''){ ?>
                          <a href="<?php echo esc_url($ebook_store_button_link); ?>" class="button redmor">
                          <?php echo esc_html($ebook_store_button_text); ?>
                            <span class="screen-reader-text"><?php echo esc_html($ebook_store_button_text); ?></span>
                          </a>
                        <?php } ?>
                      </div>
                    <?php } ?>
  ...
  <?php if( get_theme_mod('ebook_store_banner_page') != ''){ ?>
