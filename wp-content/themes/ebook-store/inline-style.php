<?php
	...
	if($vw_book_store_first_color != false){
		$vw_book_store_custom_css .='.products li:hover a.add_to_cart_button, #footer .custom-social-icons i,.wp-block-tag-cloud a:hover, .entry-content .wp-block-button__link,.wp-block-woocommerce-cart .wc-block-cart__submit-button, .wc-block-components-checkout-place-order-button, .wc-block-components-totals-coupon__button,.wp-block-woocommerce-empty-cart-block .wc-block-grid__product-onsale, .wp-block-woocommerce-cart .wc-block-components-product-badge{';
	...
	if($vw_book_store_first_color != false){
		$vw_book_store_custom_css .='#sidebar ul li a:hover,a.wc-block-components-product-name, .wc-block-components-product-name{';
			$vw_book_store_custom_css .='color: '.esc_attr($vw_book_store_first_color).'!important;';
		$vw_book_store_custom_css .='}';
	}
	if($vw_book_store_first_color != false){
