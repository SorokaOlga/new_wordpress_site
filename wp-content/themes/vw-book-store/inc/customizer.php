   ...
   $wp_customize->add_setting( 'vw_book_store_excerpt_number', array(
    ...
    $wp_customize->add_control( new VW_Book_Store_Toggle_Switch_Custom_Control( $wp_customize, 'vw_book_store_sidebar_hide_show',array(
      ...
      'section' => 'vw_book_store_responsive_media'
   	...
   	$wp_customize->add_setting( 'vw_book_store_responsive_preloader_hide',array(
        'default' => false,
        'transport' => 'refresh',
        'sanitize_callback' => 'vw_book_store_switch_sanitization'
    ) );
    $wp_customize->add_control( new VW_Book_Store_Toggle_Switch_Custom_Control( $wp_customize, 'vw_book_store_responsive_preloader_hide',array(
        'label' => esc_html__( 'Show / Hide Preloader','vw-book-store' ),
        'section' => 'vw_book_store_responsive_media'
    )));
