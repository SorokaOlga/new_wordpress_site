    ...
    <div class="tab-sec">
		<div class="tab">
			...
			<button class="tablinks" onclick="vw_book_store_open_tab(event, 'product_addons_editor')"><?php esc_html_e( 'Woocommerce Product Addons', 'vw-book-store' ); ?></button>
		  	...
		  	<button class="tablinks" onclick="vw_book_store_open_tab(event, 'get_bundle')"><?php esc_html_e( 'Get 250+ Themes Bundle at $99', 'vw-book-store' ); ?></button>
		</div>
			...
			<div class="lite-theme-tab" style="<?php echo esc_attr($vw_book_store_plugin_custom_css); ?>">
				...
				<div class="col-right-inner">
	                ...
	                <ul>
	                  	...
	                  	<p><?php esc_html_e(' Once you are done with this, then follow the','vw-book-store'); ?> <a class="doc-links" href="https://preview.vwthemesdemo.com/docs/free-vw-books-store/" target="_blank"><?php esc_html_e('Documentation','vw-book-store'); ?></a></p>
	                </ul>
			  	</div>
			</div>
		</div>
			...
			<div class="gutenberg-editor-tab" style="<?php echo esc_attr($vw_book_store_plugin_custom_css); ?>">
				<div class="block-pattern-img">
					...
					<p><?php esc_html_e('Follow the below instructions to setup Home page with Block Patterns.','vw-book-store'); ?></p>
	              	<p><b><?php esc_html_e('Click on Below Add new page button >> Click on "+" Icon.','vw-book-store'); ?></b></p>
				    ...
				    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/inc/getstart/images/block-pattern1.png" alt="" />
				    	<p><b><?php esc_html_e('Click on Patterns Tab >> Click on Theme Name >> Click on Sections >> Publish.','vw-book-store'); ?></b></p>
		...
		<div id="product_addons_editor" class="tabcontent">
			...
			<?php }else{ ?>
				...
				<div class="vw-book-store-pattern-page">
					...
					<p><b><?php esc_html_e('2. Go To Dashboard >> Ibtana Settings >> Woocommerce Templates','vw-book-store'); ?></b></p>
	              	<div class="vw-book-store-pattern-page">
	              	...
	              	<p><?php esc_html_e('You can create a template as you like.','vw-book-store'); ?></p>
			    </div>
			<?php } ?>
		</div> 
		   ...
		   <div class="col-left-pro">
		   	<h3><?php esc_html_e( 'WP Theme Bundle', 'vw-book-store' ); ?></h3>
		    	...
		    	<div class="feature">
		    		...
		    		<p><?php esc_html_e('250+ Premium Themes & 5+ Plugins.', 'vw-book-store'); ?></p>
		    		<p><?php esc_html_e('Seamless Integration.', 'vw-book-store'); ?></p>
		    		<p><?php esc_html_e('Customization Flexibility.', 'vw-book-store'); ?></p>
		    		<p><?php esc_html_e('Regular Updates.', 'vw-book-store'); ?></p>
		    		<p><?php esc_html_e('Dedicated Support.', 'vw-book-store'); ?></p>
		    	</div>
		    	<p>Upgrade now and give your website the professional edge it deserves, all at an unbeatable price of $99!</p>
		    	<div class="pro-links">
					<a href="<?php echo esc_url( VW_BOOK_STORE_THEME_BUNDLE_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Buy Now', 'vw-book-store'); ?></a>
					<a href="<?php echo esc_url( VW_BOOK_STORE_THEME_BUNDLE_DOC ); ?>" target="_blank"><?php esc_html_e('Documentation', 'vw-book-store'); ?></a>
				</div>
		   </div>
		   <div class="col-right-pro">
