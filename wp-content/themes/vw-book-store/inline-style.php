<?php
	...
	if($vw_book_store_second_color != false){
		$vw_book_store_custom_css .='.woocommerce #respond input#submit:hover, .woocommerce a.button:hover, .woocommerce button.button:hover, .woocommerce input.button:hover, .woocommerce #respond input#submit.alt:hover, .woocommerce a.button.alt:hover, .woocommerce button.button.alt:hover, .woocommerce input.button.alt:hover, .wp-block-woocommerce-cart .wc-block-cart__submit-button, .wc-block-components-checkout-place-order-button, .wc-block-components-totals-coupon__button,.wp-block-woocommerce-cart .wc-block-components-product-badge,.wp-block-woocommerce-empty-cart-block .wc-block-grid__product-onsale,.wp-block-woocommerce-empty-cart-block a.wp-block-button__link.add_to_cart_button.ajax_add_to_cart,.products li:hover a.added_to_cart{';
	...
	if($vw_book_store_copyright_alignment != false){
		$vw_book_store_custom_css .='.copyright p,#footer-2 p{';
	...
	$vw_book_store_responsive_preloader_hide = get_theme_mod('vw_book_store_responsive_preloader_hide',false);
	if($vw_book_store_responsive_preloader_hide == true && get_theme_mod('vw_book_store_loader_enable',false) == false){
		$vw_book_store_custom_css .='@media screen and (min-width:575px){
			#preloader{';
			$vw_book_store_custom_css .='display:none !important;';
		$vw_book_store_custom_css .='} }';
	}

	if($vw_book_store_responsive_preloader_hide == false){
		$vw_book_store_custom_css .='@media screen and (max-width:575px){
			#preloader{';
			$vw_book_store_custom_css .='display:none !important;';
		$vw_book_store_custom_css .='} }';
